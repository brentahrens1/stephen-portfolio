    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" priority src="/images/projects/nice-hands/nice-hands-banner.png" alt="test"  />
            </div>
            ...
            <div className="page__banner">
                <Image width={400} height={580} layout="responsive" priority src="/images/projects/nice-hands/nice-hands-3.png" alt="test"  />
            </div>
        </div>
    )
}