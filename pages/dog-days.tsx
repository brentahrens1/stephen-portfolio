    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" src="/images/projects/young-planet/dog-days-header.png" />
            </div>
            ...
            <div className="page__banner">
                <Image width={400} height={280} layout="responsive" src="/images/projects/young-planet/dog-days-1.png" />
            </div>
            <div className="page__content">
                <h2>Concept</h2>
            ...
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" src="/images/projects/young-planet/dog-days-2.png" />
            </div>
            <div className="page__banner">
                <Image width={400} height={280} layout="responsive" src="/images/projects/young-planet/dog-days-3.png" />
            </div>
        </div>
    )
}