    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" priority={true} src="/images/projects/wave-festival/wave-banner.png" alt="test"  />
            </div>
            ...
            <div className="page__image last">
                <Image width={400} height={550} layout="responsive" priority={true} src="/images/projects/wave-festival/wave-2.png" alt="test"  />
            </div>
            <div className="page__content">
                <h2>Concept</h2>
            ...
            <div className="page__banner">
                <Image width={400} height={280} layout="responsive" priority={true} src="/images/projects/wave-festival/wave-3.png" alt="test"  />
            </div>
        </div>
    )
}