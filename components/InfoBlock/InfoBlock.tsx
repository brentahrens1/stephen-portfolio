    ...
    return (
        <div className="info-block">
            <div>
                ...
                <p>Browse my latest projects below,<br />view my <a className="link" href="/resume/STEPHEN_GALGANO_GD_RESUME_2022.pdf" target="_blank" rel="noreferrer">resume</a> or say <a className="link" href="mailto:stephenjgalgano@gmail.com" target="_blank" rel="noreferrer">hey</a>.</p>
            </div>
