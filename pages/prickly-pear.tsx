    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" src="/images/projects/prickly-pear/pp-banner.png" />
            </div>
            ...
            <div className="page__banner">
                <Image width={400} height={260} layout="responsive" src="/images/projects/prickly-pear/pp-2.png" />
            </div>
            <div className="page__content">
                <h2>Concept</h2>
            ...
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" src="/images/projects/prickly-pear/pp-3.png" />
            </div>
            <div className="page__image">
                <Image width={450} height={160} layout="responsive" src="/images/projects/prickly-pear/pp-4.png" />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" src="/images/projects/prickly-pear/pp-1.png" />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" src="/images/projects/prickly-pear/pp-7.png" />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" src="/images/projects/prickly-pear/pp-5.png" />
            </div>
            <div className="page__banner">
                <Image width={400} height={280} layout="responsive" src="/images/projects/prickly-pear/pp-1.png" />
            </div>
