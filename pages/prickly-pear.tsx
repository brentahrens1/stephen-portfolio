    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" priority={true} src="/images/projects/prickly-pear/pp-banner.png" alt="test" />
            </div>
            ...
            <div className="page__banner">
                <Image width={400} height={260} layout="responsive" priority={true} src="/images/projects/prickly-pear/pp-2.png" alt="test"  />
            </div>
            <div className="page__content">
                <h2>Concept</h2>
