    ...
    return (
        <div className="page">
            <div className="page__banner">
                <Image width={400} height={190} layout="responsive" priority src="/images/projects/prickly-pear/pp-banner.png" alt="test" />
            </div>
            ...
            <div className="page__banner">
                <Image width={400} height={260} layout="responsive" priority src="/images/projects/prickly-pear/pp-2.png" alt="test"  />
            </div>
            <div className="page__content">
                <h2>Concept</h2>
            ...
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" priority src="/images/projects/prickly-pear/pp-3.png" alt="test"  />
            </div>
            <div className="page__image">
                <Image width={450} height={160} layout="responsive" priority src="/images/projects/prickly-pear/pp-4.png" alt="test"  />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" priority src="/images/projects/prickly-pear/pp-1.png" alt="test"  />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" priority src="/images/projects/prickly-pear/pp-7.png" alt="test"  />
            </div>
            <div className="page__image">
                <Image width={400} height={280} layout="responsive" priority src="/images/projects/prickly-pear/pp-5.png" alt="test"  />
            </div>
            <div className="page__banner">
                <Image width={400} height={280} layout="responsive" priority src="/images/projects/prickly-pear/pp-1.png" alt="test"  />
            </div>
